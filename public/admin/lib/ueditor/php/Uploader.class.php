...
class Uploader
{
	...
	{
            if($this->config['shop_id']==0){
                $pathStr = $_SERVER['DOCUMENT_ROOT'].'/upload/'.$this->config['website_id'].'/customer/';//$this->config['savePath'];
            }else{
                $pathStr = $_SERVER['DOCUMENT_ROOT'].'/upload/'.$this->config['website_id'].'/'.$this->config['shop_id'].'/customer/';//$this->config['savePath'];
            }
