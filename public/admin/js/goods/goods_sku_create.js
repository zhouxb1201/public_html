...
$(".sku-picture-span").on("click",function(){
...
function createTable(){
	...
	if($specObj.length == 0){
		...
		// $("#txtProductMarketPrice").prop("required",true);
		// $("#txtProductCostPrice").prop("required",true);
	...
	for(var i = 0; i < $sku_array.length; i ++){
		...
		if($temp_Obj[child_id_string] == undefined){
			...
			$temp_Obj[child_id_string]["sku_price"] ="";
			$temp_Obj[child_id_string]["market_price"] ="";
			$temp_Obj[child_id_string]["cost_price"] ="";
			$temp_Obj[child_id_string]["stock_num"] ="";
		...
		html +='<td class="w15">';
		html +='<input type="text" data-visi-type="prices_1" name="sku_price" required class="js-price input-mini form-control" maxlength="10" value="'+$temp_Obj[child_id_string]["sku_price"]+'" >';
		// html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">销售价最小为 0.01</span>';
		html +='</td>';
		html +='<td class="w15">';
		html +='<input type="text" data-visi-type="prices_1" name="market_price" required maxlength="10" class="form-control js-market-price" value="'+$temp_Obj[child_id_string]["market_price"]+'">';
		// html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">市场价最小为 0.01</span>';
		html +='</td>';
		html +='<td class="w15">';
		html +='<input type="text" name="cost_price" maxlength="10" class="form-control js-cost-price" value="'+$temp_Obj[child_id_string]["cost_price"]+'">';
		// html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">成本价最小为 0.01</span>';
		html +='</td>';
		html +='<td class="w15">';
		html +='<input type="text" data-visi-type="prices_1" name="stock_num" class="form-control js-stock-num input-mini" required maxlength="9" value="'+$temp_Obj[child_id_string]["stock_num"]+'" onkeyup="inputKeyUpNumberValue(this);" onafterpaste="inputAfterPasteNumberValue(this);"/>';
		// html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">库存不能为空</span>';
		html +='</td>';
		html +='<td class="w15"><input type="text" name="code" class="form-control js-code input-small" value="'+$temp_Obj[child_id_string]["code"]+'"/></td>';
		html +="</tr>";
	}
	...
	tf_html +='	<a class="js-batch-merchant-code" href="javascript:;">商品货号</a>';
	tf_html +='	</span>';
	...
	tf_html +='<span class="js-batch-save goods-sku-add" style="margin-right:10px;">保存</span>';
	tf_html +='<span class="js-batch-cancel goods-sku-cancle">取消</span>';
