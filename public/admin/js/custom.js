define(['utilAdmin','jquery-ui'], function (util) {
    ...
    modal.initData = function(data){
        ...
        if (modal.data) {
            ...
            if(modal.type === 1){
                ...
                modal.items = modal.defaultShopItems()

            }else if(modal.type === 3){
                modal.items = modal.defaultDetailItems()

            }else if(modal.type === 4){
                modal.items = modal.defaultMemberItems()

            }else if(modal.type === 5){
                modal.items = modal.defaultCommissionItems()
    ...
    modal.initEditor = function (scroll) {
        ...
        $('#selectGoods').unbind('click').click(function () {
            ...
            util.goodsDialog('url:'+__URL(ADMINMAIN+ '/config/modalGoodsList?t='+(new Date()).getTime()),function(data){
                ...
                session.setItem('goods_data_'+itemid,JSON.stringify(data));
    ...
    modal.initNavs = function () {
        ...
        var navgroup = {
            ...
            1: ['search','menu','notice','banner','picturew','shop'],
