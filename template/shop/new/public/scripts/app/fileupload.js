...
define(["jquery","layer"], function (jQuery) {
    var fileupload = {};
    ...
    fileupload.createUploadForm = function (id, fileElementId, data) {
        // create form
    ...
    fileupload.ajaxFileUpload = function (s) {
        ...
        var uploadCallback = function (isTimeout) {
            ...
            try {
                ...
                fileupload.handleError(s, xml, null, e);
            ...
            if (xml || isTimeout == "timeout") {
                ...
                try {
                    ...
                    if (status != "error") {
                        ...
                        var data = fileupload.uploadHttpData(xml,
                                s.dataType);
                        ...
                        fileupload.handleError(s, xml, status);

                } catch (e) {

                    status = "error";

                    fileupload.handleError(s, xml, status, e);
    ...
    fileupload.handleError = function (s, xhr, status, e) {
        // If a local callback was specified, fire it
        if (s.error) {
