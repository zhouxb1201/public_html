<template>
  <div>
    <div class="prize-wrap">
      <h3 class="prize-title">幸运大转盘中奖记录</h3>
...
<script>
import { GET_PRIZERECORDS } from "@/api/wheelsurf";
export default {
  data() {
    return {
      listData: [],
  ...
  methods: {
    loadData() {
      let $this = this;
      $this.params.wheelsurf_id = $this.$route.params.wheelsurfid
        ? $this.$route.params.wheelsurfid
        : null;
