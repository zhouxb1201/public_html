...
Page({
  ...
  onLoad: function (options) {
    ...
    if (options.shopkeeper_id || wx.getStorageSync("shopkeeper_id")) {
      this.data.shopkeeper_id = options.shopkeeper_id || wx.getStorageSync("shopkeeper_id");
    }
    this.setData({
  ...
  getGoodsList: function () {
    ...
    let postData = {
      ...
      'microshop_type': 1,
      'shopkeeper_id': that.data.shopkeeper_id
    }
  ...
  toGoodsDetail: function (e) {
    ...
    wx.navigateTo({
      url: '../../../../../pages/goods/detail/index?goodsId=' + target.id + '&shopkeeper_id=' + this.data.shopkeeper_id,
    })
  }
