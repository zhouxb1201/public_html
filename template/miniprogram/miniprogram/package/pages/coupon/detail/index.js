...
Page({
  ...
  onLoad: function (options) {
    this.data.coupon_type_id =  options.coupon_type_id
  },
  ...
  couponDetail:function(){
    ...
    re.request(api.get_couponDetail, postData, header).then((res) =>{
      if(res.data.code == 1){
        ...
        couponDetail.start_time = time.js_date_time_second(couponDetail.start_time);
        couponDetail.end_time = time.js_date_time_second(couponDetail.end_time);
        that.setData({
