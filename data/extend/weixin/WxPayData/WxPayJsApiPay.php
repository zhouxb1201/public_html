...
class WxPayJsApiPay extends WxPayDataBase
{
    ...
    public function SetAppids($value)
    {
        $this->values['appid'] = $value;
    }
    public function GetAppids($value)
    {
    ...
    public function SetNonceStrs($value)
    {
        $this->values['noncestr'] = $value;
    }
    public function GetNonceStrs()
    {
        return $this->values['noncestr'];
    }
    /**
    ...
    public function SetPaySigns($value)
    {
